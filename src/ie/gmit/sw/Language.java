...
public enum Language {
    ...
    // I was getting an error with No enum constant ie.gmit.sw.Language.OldEnglish this fixed it for me
    public static boolean isEnum(String value, Class<Language> enumClass) {
